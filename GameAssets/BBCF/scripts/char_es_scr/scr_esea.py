...
def esef_340_circle2():
    ...
    label(0)
    sprite('null', 10)
    TriggerUponForState('esef_340_circle2Add', 32)
    AlphaValue(255)
    ConstantAlphaModifier(0)
    Size(750)
    SetScaleSpeed(0)
...
def esef_402Eff():
    ...
    TriggerUponForState('esef_402EffAdd', 33)
    TriggerUponForState('esef_402EffKidou', 33)
    RemoveOnCallStateEnd(0)
    ConstantAlphaModifier(-8)
    sprite('null', 2)
...
def esef_405Eff():
    ...
    TriggerUponForState('esef_405EffAdd', 32)
    RemoveOnCallStateEnd(0)
    ConstantAlphaModifier(-25)
...
def esef_405EffAddAtk():
    ...
    IgnoreFinishStop(1)
    sprite('null', 10)
    TriggerUponForState('esef_405EffAddAtkadd', 32)
    IgnoreFinishStop(0)
    RemoveOnCallStateEnd(0)
    ConstantAlphaModifier(-25)
...
def esef_406Eff2():
    ...
    sprite('null', 20)
    TriggerUponForState('esef_406Eff', 32)
...
def esef_406Eff2EX():
    ...
    CreateObject('esef_406Effadd2', -1)
    sprite('null', 10)
    TriggerUponForState('esef_406EffEX', 32)
...
def esef_406EffAddAtk():
    ...
    IgnoreFinishStop(1)
    sprite('null', 10)
    TriggerUponForState('esef_406EffAddAtkadd', 32)
    IgnoreFinishStop(0)
    RemoveOnCallStateEnd(0)
    ConstantAlphaModifier(-25)
...
def esef_406EffAddAtk2():
    ...
    DespawnEAEffect('esef_406Effadd')
    sprite('null', 10)
    TriggerUponForState('esef_406EffAddAtkadd2', 32)
    IgnoreFinishStop(0)
    RemoveOnCallStateEnd(0)
    ConstantAlphaModifier(-25)
...
def esef_430EffStartOD():
    ...
    TriggerUponForState('esef_430EffStartODhikari', 32)
...
def esef_431Eff():
    ...
    Visibility(1)
    Size(1200)
    TriggerUponForState('esef_431Emb', 32)
    TriggerUponForState('esef_431EffSub', 32)
    IgnoreScreenfreeze(1)
    ...
    TriggerUponForState('esef_431Tossin', 32)
...
def esef_431Emb():
    ...
    sprite('null', 20)
    RenderLayer(15)
    TriggerUponForState('esef_431EmbAdd', 32)
    ConstantAlphaModifier(-12)
    SetScaleSpeed(5)
    Unknown4022(0)
    RemoveOnCallStateEnd(0)
